...
/*
 * var image = $('#img')[0]; image.addEventListener('zoom', function (e) {
...
/*
 * $('#img').on('zoom.cropper', function (e) { alert(e.detail.oldRatio + '->' +
 * e.detail.ratio); });
 */
 ...
 *            e イベントオブジェクト
 * @param {String}
 *            callback 画像リサイズ後に行わせたい処理
 * @param {String}
 *            startProc 画像リサイズ開始時に行わせたい処理
 * @param {String}
 *            endProc 画像リサイズ全処理終了後に行わせたい処理
 */
